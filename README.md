...
For the purposes of ETH SF, Delegate Cash went live on Optimism
...
Text found below is sourced from the original repositories found at:

https://github.com/0xfoobar/delegation-registry

and 

https://github.com/0xfoobar/delegate-cash-frontend
